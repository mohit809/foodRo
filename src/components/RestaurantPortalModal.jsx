...
export default function RestaurantPortalModal({
  ...
  const [activeTab, setActiveTab] = useState('add_dish'); // 'add_dish' | 'add_restaurant' | 'manage'
  ...
  // Quick image presets for dishes
  const imagePresets = [
  ...
  const handleAddDishSubmit = (e) => {
    ...
    // Calculate raw USD base price if user entered in selected currency
    const rawInput = parseFloat(dishPrice) || 5;
    // In INR, ₹350 is ~$4.04 USD. Let's normalize appropriately
      ...
      >
        ...
        <div className="p-5 border-b border-slate-200 flex items-center justify-between bg-slate-900 text-white">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-base font-extrabold text-white">foodRo Partner Portal</h2>
              <p className="text-xs text-slate-400">List your restaurant, hotel, and dishes</p>
            </div>
          </div>
          <button 
            onClick={onClose}
            className="w-8 h-8 rounded-full hover:bg-white/10 text-white/70 hover:text-white flex items-center justify-center transition"
          >
            <X className="w-5 h-5" />
          </button>
        </div>
        ...
        <div className="flex border-b border-slate-200 bg-slate-50 px-6 pt-2">
          {[
            ...
            { id: 'add_restaurant', label: '🏨 Register Hotel / Restaurant', icon: Building2 },
            { id: 'manage', label: `📋 Menu Items (${foodItems.length})`, icon: Store }
          ].map(tab => {
            const Icon = tab.icon;
        ...
        <div className="p-6 overflow-y-auto space-y-6 flex-1">
          ...
          {activeTab === 'add_dish' && (
            <form onSubmit={handleAddDishSubmit} className="space-y-4">
              <div className="p-3 bg-amber-50 rounded-2xl border border-amber-200 text-xs text-amber-900 flex items-center gap-2">
                ...
                <span>Add any food item (Momos, Pizza, Burger, Noodles, Biryani) and it will immediately be live on foodRo!</span>
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    placeholder="e.g. Steamed Chicken Momos, Paneer Pizza..."
              ...
              <div className="flex items-center gap-6 pt-1">
                <label className="flex items-center gap-2 cursor-pointer">
                  ...
                  />
                  <span className="text-xs font-bold text-slate-800">🌱 Pure Vegetarian</span>
                </label>
                ...
                <label className="flex items-center gap-2 cursor-pointer">
                  ...
                  />
                  <span className="text-xs font-bold text-slate-800">★ Mark as Bestseller</span>
                </label>
              </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  placeholder="Describe ingredients, cooking style, and dipping sauces..."
              ...
              <button
                type="submit"
                className="w-full py-3.5 rounded-2xl bg-orange-500 hover:bg-orange-600 text-white font-extrabold text-xs shadow-lg shadow-orange-500/30 transition flex items-center justify-center gap-2 cursor-pointer"
              >
          ...
          {/* TAB 2: REGISTER RESTAURANT / HOTEL */}
          {activeTab === 'add_restaurant' && (
            <form onSubmit={handleAddRestaurantSubmit} className="space-y-4">
              <div className="p-3 bg-emerald-50 rounded-2xl border border-emerald-200 text-xs text-emerald-900 flex items-center gap-2">
                ...
                <span>Register a new hotel or cloud kitchen to start listing your specialized menus.</span>
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  placeholder="e.g. Royal Momo Hub, Grand Pizza Palace, Oberoi Gourmet..."
                  className="w-full p-2.5 rounded-xl border border-slate-200 focus:border-orange-500 text-xs font-semibold text-slate-900 outline-none"
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  placeholder="e.g. Himalayan Momos, Tibetan Thukpa, Chinese"
                  className="w-full p-2.5 rounded-xl border border-slate-200 focus:border-orange-500 text-xs text-slate-900 outline-none"
                />
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    placeholder="e.g. Sector 18, Connaught Place, Shibuya"
                    className="w-full p-2.5 rounded-xl border border-slate-200 focus:border-orange-500 text-xs text-slate-900 outline-none"
                  />
                </div>
              ...
              <div>
                <label className="block text-xs font-bold text-slate-700 uppercase tracking-wide mb-1">
                  Hotel / Restaurant Banner Image URL
                </label>
                <input
                  type="text"
                  value={restImage}
              ...
              <button
                type="submit"
                className="w-full py-3.5 rounded-2xl bg-emerald-600 hover:bg-emerald-700 text-white font-extrabold text-xs shadow-lg shadow-emerald-600/30 transition flex items-center justify-center gap-2 cursor-pointer"
              >
            ...
            <div className="space-y-3">
              <div className="flex items-center justify-between">
                <span className="text-xs font-extrabold text-slate-900">
                  Total Active Food Items: {foodItems.length}
                </span>
                <button
                ...
                {foodItems.map(item => (
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-[11px] text-slate-500 truncate">{item.restaurant.name}</p>
