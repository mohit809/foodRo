    ...
    <div className="bg-white rounded-3xl overflow-hidden border border-slate-200/80 shadow-xs hover:shadow-xl transition-all duration-300 flex flex-col group">
      ...
      <div className="relative h-48 sm:h-52 w-full overflow-hidden bg-slate-100">
        ...
        <div className="absolute top-3 left-3 flex items-center gap-2">
          {/* Veg / Non-Veg icon */}
          <div className="w-6 h-6 rounded-lg bg-white/90 backdrop-blur-xs flex items-center justify-center shadow-xs">
          ...
          {/* Bestseller badge */}
          {food.isBestseller && (
            <span className="px-2.5 py-0.5 rounded-full bg-orange-500 text-white text-[11px] font-extrabold uppercase tracking-wider flex items-center gap-1 shadow-xs">
        ...
        <button
          ...
          className="absolute top-3 right-3 w-8 h-8 rounded-full bg-white/90 backdrop-blur-xs hover:bg-white flex items-center justify-center text-slate-700 shadow-md transition hover:scale-110 active:scale-95 cursor-pointer"
        ...
        <div className="absolute bottom-3 left-3 right-3 flex items-center justify-between text-white text-xs font-semibold">
          ...
          <span className="flex items-center gap-1 bg-black/40 backdrop-blur-xs px-2.5 py-1 rounded-full text-slate-200">
      ...
      <div className="p-5 flex flex-col flex-1 justify-between">
        <div>
          ...
          <div className="flex items-center justify-between gap-2 mb-1.5">
            <span className="text-xs font-bold text-orange-600 tracking-wide uppercase truncate">
          ...
          <h3 
            ...
            className="font-bold text-slate-900 text-base leading-snug mb-2 group-hover:text-orange-600 transition cursor-pointer"
          >
            {food.name}
          </h3>
        ...
        <div className="pt-3 border-t border-slate-100 flex items-center justify-between">
          ...
          {quantityInCart > 0 ? (
            <div className="flex items-center gap-2 bg-orange-500 text-white rounded-2xl px-2 py-1 shadow-md shadow-orange-500/30">
              <button
            ...
            <button
              onClick={() => onOpenCustomize(food)}
              className="flex items-center gap-1 px-4 py-2 rounded-2xl bg-orange-50 hover:bg-orange-500 text-orange-600 hover:text-white font-bold text-xs border border-orange-200 hover:border-orange-500 shadow-xs transition duration-200 active:scale-95 cursor-pointer"
            >
              <Plus className="w-3.5 h-3.5" />
              <span>ADD</span>
            </button>
